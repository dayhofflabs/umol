...
mod tests {
    ...
    #[case::whitespace_1(b" ", M0Error::UnsupportedToken { pos: 0 })]
    #[case::whitespace_2(b"\t", M0Error::UnsupportedToken { pos: 0 })]
    #[case::whitespace_3(b"\n", M0Error::UnsupportedToken { pos: 0 })]
    #[case::whitespace_4(b"\r", M0Error::UnsupportedToken { pos: 0 })]
    #[case::whitespace_5(b"\r\n", M0Error::UnsupportedToken { pos: 0 })]
    #[case::leading_whitespace_1(b" C", M0Error::UnsupportedToken { pos: 0 })]
    #[case::leading_whitespace_2(b"\tC", M0Error::UnsupportedToken { pos: 0 })]
    #[case::leading_whitespace_3(b"\nC", M0Error::UnsupportedToken { pos: 0 })]
    #[case::leading_whitespace_4(b"\rC", M0Error::UnsupportedToken { pos: 0 })]
    #[case::leading_whitespace_5(b"\r\nC", M0Error::UnsupportedToken { pos: 0 })]
    #[case::trailing_whitespace_1(b"C ", M0Error::UnsupportedToken { pos: 1 })]
    #[case::trailing_whitespace_2(b"C\t", M0Error::UnsupportedToken { pos: 1 })]
    #[case::trailing_whitespace_3(b"C\n", M0Error::UnsupportedToken { pos: 1 })]
    #[case::trailing_whitespace_4(b"C\r", M0Error::UnsupportedToken { pos: 1 })]
