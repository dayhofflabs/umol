...
#[case::group_leading_bond_1(b"(-C)C", ParseError::GroupLeadingBond { pos: 1 })]
#[case::group_leading_bond_2(b"(=C)C", ParseError::GroupLeadingBond { pos: 1 })]
#[case::group_leading_bond_3(b"(#C)C", ParseError::GroupLeadingBond { pos: 1 })]
#[case::group_leading_bond_4(b"($C)C", ParseError::GroupLeadingBond { pos: 1 })]
#[case::group_leading_stereobond_1(b"(/C)C", ParseError::GroupLeadingBond { pos: 1 })]
#[case::group_leading_stereobond_2(b"(\\C)C", ParseError::GroupLeadingBond { pos: 1 })]
#[case::group_leading_aromatic_bond(b"(:C)C", ParseError::GroupLeadingBond { pos: 1 })]
...
#[case::dot_in_group_1(b"(.)", ParseError::GroupLeadingDot { pos: 1 })]
#[case::dot_in_group_2(b"(.)C", ParseError::GroupLeadingDot { pos: 1 })]
#[case::dot_in_group_3(b"(.).C", ParseError::GroupLeadingDot { pos: 1 })]
#[case::leading_dot_in_group_1(b"(.CC)", ParseError::GroupLeadingDot { pos: 1 })]
#[case::leading_dot_in_group_2(b"(.CC).(CC)", ParseError::GroupLeadingDot { pos: 1 })]
#[case::leading_dot_in_group_3(b"(CC).(.CC)", ParseError::GroupLeadingDot { pos: 6 })]
#[case::leading_dot_in_group_4(b"(.C).(.C)", ParseError::GroupLeadingDot { pos: 1 })]
#[case::leading_dot_in_group_5(b"C.(.C).C", ParseError::GroupLeadingDot { pos: 3 })]
...
#[case::dot_in_component_2(b"(.).C", ParseError::GroupLeadingDot { pos: 1 })]
#[case::dot_in_component_3(b"(.).(C)", ParseError::GroupLeadingDot { pos: 1})]
#[case::dot_in_component_4(b"C.()", ParseError::EmptyGroup { pos: 3 })]
#[case::dot_in_component_5(b"C.(.)", ParseError::GroupLeadingDot { pos: 3 })]
#[case::dot_in_component_6(b"(C).(.)", ParseError::GroupLeadingDot { pos: 5 })]
...
#[case::group_dot_before_ring_digit(b"(.1)", ParseError::GroupLeadingDot { pos: 1 })]
#[case::group_dot_before_ring_percent(b"(.%12)", ParseError::GroupLeadingDot { pos: 1 })]
...
#[case::group_dot_before_bond(b"(.-C)", ParseError::GroupLeadingDot { pos: 1 })]
...
#[case::hcount_outside_bracket(b"CHC", ParseError::InvalidElement { pos: 1 })]
