...
fn extended_reaction_from_sides(
    ...
    let reactants: Vec<_> = reactants
        .into_iter()
        .map(|s| build_extended_from_graph(s))
        .collect();
...
#[case::two_reactants(b"C.C>>C", extended_reaction_from_sides(["C@0 |", "C@0 |"], ["C@0 |"], []))]
#[case::two_products(b"C>>C.C", extended_reaction_from_sides(["C@0 |"], ["C@0 |", "C@0 |"], []))]
...
#[rstest]
#[case::dative_bond(b"N->B>>N.B", extended_reaction_from_sides(["N@0 B@3 | 0-1->@1"], ["N@0 |", "B@0 |"], []))]
