...
use super::super::*;
use super::utils::build_extended_from_graph;
...
#[case::cis_2_eq_3(b"C/C(F)=C(/C)F", 6, 5)]
#[case::cis_2_eq_4(b"CC(/F)=C(/C)F", 6, 5)]
#[case::cis_2_eq_5(b"C/C(F)=C(C)\\F", 6, 5)]
#[case::cis_2_eq_6(b"CC(/F)=C(C)\\F", 6, 5)]
