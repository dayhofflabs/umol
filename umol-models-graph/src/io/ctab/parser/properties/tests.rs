...
#[rstest]
#[case::atom_index_is_zero(b"  0\n  Et", error::ErrorKind::Verify)]
#[case::too_short(b" 1\n  Et", error::ErrorKind::Eof)]
#[case::too_long(b"   1\n  Et", error::ErrorKind::Verify)]
fn test_atom_alias_entry_invalid(#[case] input: &[u8], #[case] expected_kind: error::ErrorKind) {
    let result = all_consuming(atom_alias_entry()).parse(input);
    let input_str = input.to_str_lossy();
...
#[rustfmt::skip]
#[rstest]
#[case::trailing_chars(b"M  CHG  1   1  -1  a", error::ErrorKind::Eof)]
#[case::count_mismatch(b"M  CHG  2   1  -1", error::ErrorKind::Tag)]
#[case::count_zero(b"M  CHG  0", error::ErrorKind::Verify)]
#[case::atom_index_zero(b"M  CHG  1   0 -10", error::ErrorKind::Verify)]
#[case::invalid_property_tag(b"M  XXX  1   1  -1", error::ErrorKind::Tag)]
#[case::zbo_clark_extensions(b"M  ZBO  1   1   0", error::ErrorKind::Tag)]
#[case::zch_clark_extensions(b"M  ZCH  1   1  -1", error::ErrorKind::Tag)]
#[case::hyd_clark_extensions(b"M  HYD  1   1   1", error::ErrorKind::Tag)]
...
#[rstest]
#[case::atom_index_is_zero(b"  0 *", error::ErrorKind::Verify)]
fn test_atom_value_entry_invalid(#[case] input: &[u8], #[case] expected_kind: error::ErrorKind) {
    let result = all_consuming(atom_value_entry()).parse(input);
    let input_str = input.to_str_lossy();
    assert!(result.is_err(), "{:?}", input_str);
    assert!(
...
#[rustfmt::skip]
#[rstest]
#[case::trailing_characters(b"  1   1  -1  a", error::ErrorKind::Eof)]
#[case::count_exceeds_item_list_length(b"  2   1  -1", error::ErrorKind::Tag)]
#[case::item_list_exceeds_count(b"  2   1  -1   4   1   5   6", error::ErrorKind::Eof)]
#[case::count_is_zero(b"  0", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"  1   0 -10", error::ErrorKind::Verify)]
...
#[rustfmt::skip]
#[rstest]
#[case::value_out_of_range(b"  1   1   4", error::ErrorKind::Verify)]
#[case::value_is_negative(b"  1   1  -1", error::ErrorKind::Digit)]
#[case::count_exceeds_item_list_length(b"  2   1   1", error::ErrorKind::Tag)]
#[case::item_list_exceeds_count(b"  2   1   1   4   1   5   1", error::ErrorKind::Eof)]
#[case::trailing_characters(b"  1   1   2 a", error::ErrorKind::Eof)]
#[case::count_is_zero(b"  0", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"  1   0   2", error::ErrorKind::Verify)]
...
#[rstest]
#[case::value_is_negative(b"  1   1  -1", error::ErrorKind::Digit)]
#[case::count_exceeds_item_list_length(b"  2   1  10", error::ErrorKind::Tag)]
#[case::item_list_exceeds_count(b"  2   1  10   4   1   5   1", error::ErrorKind::Eof)]
#[case::trailing_characters(b"  1   1  12 a", error::ErrorKind::Eof)]
#[case::count_is_zero(b"  0", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"  1   0  12", error::ErrorKind::Verify)]
...
#[rstest]
#[case::value_out_of_range(b"  1   1   5", error::ErrorKind::Verify)]
#[case::value_out_of_range_negative(b"  1   1  -3", error::ErrorKind::Verify)]
#[case::trailing_characters(b"  1   1   2 a", error::ErrorKind::Eof)]
#[case::count_is_zero(b"  0", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"  1   0   2", error::ErrorKind::Verify)]
...
#[rstest]
#[case::value_out_of_range(b"  1   1  16", error::ErrorKind::Verify)]
#[case::value_out_of_range_negative(b"  1   1  -3", error::ErrorKind::Verify)]
#[case::trailing_characters(b"  1   1   3 a", error::ErrorKind::Eof)]
#[case::count_is_zero(b"  0", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"  1   0   3", error::ErrorKind::Verify)]
...
#[rstest]
#[case::value_out_of_range(b"  1   1   2", error::ErrorKind::Verify)]
#[case::unsigned_value_is_negative(b"  1   1  -1", error::ErrorKind::Digit)]
#[case::trailing_characters(b"  1   1   1 a", error::ErrorKind::Eof)]
#[case::count_is_zero(b"  0", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"  1   0   1", error::ErrorKind::Verify)]
...
#[rustfmt::skip]
#[rstest]
#[case::repeat_count_less_than_2(b"  1   1   1   5   7", error::ErrorKind::Verify)]
#[case::count_exceeds_4(b"  5   1   2   5   7", error::ErrorKind::Verify)]
#[case::trailing_characters(b"  1   1   2   5   7 a", error::ErrorKind::Eof)]
#[case::count_is_zero(b"  0", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"  1   0   2   5   7", error::ErrorKind::Verify)]
...
#[rstest]
#[case::count_is_zero(b"   1  0 F C   ", error::ErrorKind::Verify)]
#[case::count_exceeds_16(b"   1 17 F C   N   ", error::ErrorKind::Verify)]
#[case::invalid_exclusion_flag(b"   1  1 X C   ", error::ErrorKind::Tag)]
#[case::invalid_element_symbol(b"   1  1 F XX  ", error::ErrorKind::MapOpt)]
fn test_atom_list_entry_invalid(#[case] input: &[u8], #[case] expected_kind: error::ErrorKind) {
    let result = all_consuming(atom_list_entry()).parse(input);
    let input_str = input.to_str_lossy();
    assert!(result.is_err(), "{:?} should have failed", input_str);
    assert!(
...
#[rustfmt::skip]
#[rstest]
#[case::attachment_type_out_of_range(b"  1   1   4", error::ErrorKind::Verify)]
#[case::count_is_zero(b"  0   1", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"  1   0   1", error::ErrorKind::Verify)]
#[case::count_exceeds_2(b"  3   1   1   2   2   3   3", error::ErrorKind::Verify)]
#[case::trailing_characters(b"  1   1   1 a", error::ErrorKind::Eof)]
...
#[rustfmt::skip]
#[rstest]
#[case::count_is_zero(b"   1   0", error::ErrorKind::Verify)]
#[case::count_exceeds_2(b"   1   3   1   2", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"   0   1   1   2", error::ErrorKind::Verify)]
#[case::attachment_type_is_zero(b"   1   1   1   2", error::ErrorKind::Verify)]
#[case::attachment_type_out_of_range(b"   1   1   1   3", error::ErrorKind::Verify)]
#[case::trailing_characters(b"   1   1   1   2 a", error::ErrorKind::Verify)]
...
#[rstest]
#[case::label_is_zero(b"  1   0", error::ErrorKind::Verify)]
#[case::count_exceeds_8(b"  9   1   2", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"  1   0   2", error::ErrorKind::Verify)]
#[case::trailing_characters(b"  1   1   2 a", error::ErrorKind::Eof)]
...
#[rustfmt::skip]
#[rstest]
#[case::count_is_zero(b"  0   1   0", error::ErrorKind::Verify)]
#[case::count_exceeds_1(b"  2   1   0", error::ErrorKind::Verify)]
#[case::label_is_zero(b"  1   0   0", error::ErrorKind::Verify)]
#[case::rgroup_or_h_out_of_range(b"  1   1   0   2", error::ErrorKind::Verify)]
...
#[rstest]
#[case::invalid_sgroup_type(b"  1   1 FOO", error::ErrorKind::MapRes)]
#[case::trailing_characters(b"  1   1 SUP a", error::ErrorKind::Eof)]
fn test_sgroup_type_entries_invalid(#[case] input: &[u8], #[case] expected_kind: error::ErrorKind) {
    let result = all_consuming(sgroup_type_entries()).parse(input);
    let input_str = input.to_str_lossy();
    assert!(result.is_err(), "{:?} should have failed", input_str);
    assert!(
...
#[rstest]
#[case::invalid_sgroup_subtype(b"  1   1 FOO", error::ErrorKind::MapRes)]
#[case::trailing_characters(b"  1   1 ALT a", error::ErrorKind::Eof)]
...
#[rstest]
#[case::label_out_of_range(b"  1   1   0", error::ErrorKind::Verify)]
#[case::label_out_of_range_high(b"  1   1 513", error::ErrorKind::Verify)]
#[case::trailing_characters(b"  1   1   1 a", error::ErrorKind::Eof)]
...
#[rstest]
#[case::count_is_zero(b"  0", error::ErrorKind::Verify)]
#[case::invalid_connectivity(b"  1   1 FOO", error::ErrorKind::MapRes)]
#[case::trailing_characters(b"  1   1 HT a", error::ErrorKind::Eof)]
...
#[rstest]
#[case::count_is_zero(b" EXP  0   1", error::ErrorKind::Verify)]
#[case::trailing_characters(b" EXP  1   1 a", error::ErrorKind::Eof)]
...
#[rstest]
#[case::count_exceeds_15(b"   1 16   1", error::ErrorKind::Verify)]
#[case::trailing_characters(b"   1  1   1 a", error::ErrorKind::Eof)]
...
#[rstest]
#[case::count_exceeds_15(b"   1 16   3", error::ErrorKind::Verify)]
#[case::trailing_characters(b"   1  4   3   4   5   6 a", error::ErrorKind::Eof)]
...
#[rstest]
#[case::sgroup_index_is_zero(b"   0 1", error::ErrorKind::Verify)]
...
#[rstest]
#[case::count_is_zero(b"   3  0", error::ErrorKind::Verify)]
#[case::trailing_characters(b"   3  3  10   9   4 a", error::ErrorKind::Eof)]
...
#[rustfmt::skip]
#[rstest]
#[case::sgroup_index_is_zero(b"   0  4    4.4700   -3.1700    4.4700   -5.7500", error::ErrorKind::Verify)]
#[case::count_is_zero(b"   1  0", error::ErrorKind::Verify)]
...
#[rustfmt::skip]
#[rstest]
#[case::sgroup_index_is_zero(b"   0   1   -0.7200   -0.4200", error::ErrorKind::Verify)]
#[case::bond_index_is_zero(b"   1   0   -0.7200   -0.4200", error::ErrorKind::Verify)]
#[case::trailing_characters(b"   1   1   -0.7200   -0.4200 a", error::ErrorKind::Eof)]
...
#[rustfmt::skip]
#[rstest]
#[case::sgroup_index_is_zero(b"   0 pH   ", error::ErrorKind::Verify)]
#[case::invalid_field_type(b"   1 pH                            X", error::ErrorKind::MapRes)]
...
#[rustfmt::skip]
#[rstest]
#[case::sgroup_index_is_zero(b"   0     0.0000    0.0000    DR    ALL  0       0", error::ErrorKind::Verify)]
#[case::invalid_display_type(b"   1     0.0000    0.0000    XR    ALL  0       0", error::ErrorKind::MapRes)]
#[case::invalid_placement_type(b"   1     0.0000    0.0000    DX    ALL  0       0", error::ErrorKind::MapRes)]
#[case::invalid_chars_type(b"   1     0.0000    0.0000    DR    NON  0       0", error::ErrorKind::Digit)]
...
#[rstest]
#[case::sgroup_index_is_zero(b"   0 4.6", error::ErrorKind::Verify)]
...
#[rustfmt::skip]
#[rstest]
#[case::count_is_zero(b"  0   1   2", error::ErrorKind::Verify)]
#[case::sgroup_index_is_zero(b"  1   0   2", error::ErrorKind::Verify)]
#[case::parent_sgroup_index_is_zero(b"  1   1   0", error::ErrorKind::Verify)]
#[case::trailing_characters(b"  1   1   2 a", error::ErrorKind::Eof)]
...
#[rstest]
#[case::count_is_zero(b"  0   1   2", error::ErrorKind::Verify)]
#[case::component_number_is_zero(b"  1   0   2", error::ErrorKind::Verify)]
#[case::trailing_characters(b"  1   1   0 a", error::ErrorKind::Eof)]
...
#[rstest]
#[case::count_is_zero(b"  0   1   0", error::ErrorKind::Verify)]
#[case::bond_index_is_zero(b"  1   0   0", error::ErrorKind::Verify)]
#[case::trailing_characters(b"  1   1   0 a", error::ErrorKind::Eof)]
...
#[rstest]
#[case::count_is_zero(b"  0   1   0", error::ErrorKind::Verify)]
#[case::atom_index_is_zero(b"  1   0   0", error::ErrorKind::Verify)]
#[case::trailing_characters(b"  1   1   0 a", error::ErrorKind::Eof)]
