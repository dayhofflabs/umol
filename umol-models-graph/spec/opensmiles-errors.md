...
- SYN_MULTIPLE_DOTS (SYN, Error): consecutive dots without an intervening component
...
- STYLE_BRACKET_ORGANIC (STYLE, Warning): prefer bare organic subset atom over equivalent bracketed form
