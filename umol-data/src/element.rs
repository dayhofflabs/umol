...
static ELEMENT_DATA: [(u8, u32, f64, &str, u8, u8, u8, u8, (i8, i8), u8, u8); 118] = [
    ...
    (36, 84, 83.798, "Kr", 4, 32, 8, 8, (0, 0), 0, 0), // Kr: allow Kr compounds
    ...
    (54, 132, 131.29, "Xe", 5, 32, 8, 8, (0, 0), 0, 0), // Xe: allow Xe compounds
    ...
    (79, 197, 196.97, "Au", 6, 25, 11, 3, (0, 5), 1, 0), // Au
...
mod tests {
    ...
    #[rstest]
    #[case(Element::H, "H", 1, 1, 1.008, 1, 1, 1, 1)]
    ...
    #[case(Element::C, -4, 1, 2, 4)]
    #[case(Element::N, -3, 1, 3, 4)]
