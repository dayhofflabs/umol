...
// Each tuple contains: (atomic_number, reference_isotope_mass, atomic_weight, symbol, period, group (32-group layout),
...
static ELEMENT_DATA: [(u8, u32, f64, &str, u8, u8, u8, u8, (i8, i8), u8, u8); 118] = [
    ...
    (6, 12, 12.011, "C", 2, 28, 4, 4, (-4, 1), 3, 4),  // C
    (7, 14, 14.007, "N", 2, 29, 5, 4, (-3, 1), 3, 4),  // N
    (8, 16, 15.999, "O", 2, 30, 6, 3, (-2, 1), 2, 3),  // O
    (9, 19, 18.998, "F", 2, 31, 7, 1, (-1, 0), 1, 1),  // F
    (10, 20, 20.180, "Ne", 2, 32, 0, 0, (0, 0), 0, 0), // Ne: no valence electrons
    (11, 23, 22.990, "Na", 3, 1, 1, 1, (-1, 1), 1, 1), // Na
    (12, 24, 24.305, "Mg", 3, 2, 2, 2, (0, 2), 1, 2),  // Mg
    (13, 27, 26.982, "Al", 3, 27, 3, 3, (-1, 3), 1, 4), // Al
    (14, 28, 28.085, "Si", 3, 28, 4, 4, (-4, 1), 2, 4), // Si
    (15, 31, 30.974, "P", 3, 29, 5, 5, (-3, 1), 3, 4), // P
    (16, 32, 32.06, "S", 3, 30, 6, 6, (-2, 1), 2, 3),  // S
    (17, 35, 35.45, "Cl", 3, 31, 7, 7, (-1, 1), 1, 1), // Cl
    (18, 40, 39.95, "Ar", 3, 32, 0, 0, (0, 0), 0, 0),  // Ar: no valence electrons
    (19, 39, 39.098, "K", 4, 1, 1, 1, (-1, 1), 1, 0),  // K
    (20, 40, 40.078, "Ca", 4, 2, 2, 2, (0, 2), 2, 0),  // Ca
    (21, 45, 44.956, "Sc", 4, 3, 3, 3, (0, 3), 3, 0),  // Sc
    (22, 48, 47.867, "Ti", 4, 18, 4, 4, (0, 4), 4, 0), // Ti
    (23, 51, 50.942, "V", 4, 19, 5, 5, (0, 5), 5, 0),  // V
    (24, 52, 51.996, "Cr", 4, 20, 6, 6, (0, 6), 6, 0), // Cr
    (25, 55, 54.938, "Mn", 4, 21, 7, 7, (0, 7), 7, 0), // Mn
    (26, 56, 55.845, "Fe", 4, 22, 8, 6, (0, 6), 6, 0), // Fe
    (27, 59, 58.933, "Co", 4, 23, 9, 5, (0, 5), 5, 0), // Co
    (28, 58, 58.693, "Ni", 4, 24, 10, 4, (0, 4), 4, 0), // Ni
    (29, 63, 63.546, "Cu", 4, 25, 11, 3, (0, 3), 3, 0), // Cu
    (30, 64, 65.38, "Zn", 4, 26, 2, 2, (0, 2), 2, 0),  // Zn
    (31, 69, 69.723, "Ga", 4, 27, 3, 3, (0, 3), 3, 0), // Ga
    (32, 74, 72.630, "Ge", 4, 28, 4, 4, (0, 4), 4, 0), // Ge
    (33, 75, 74.922, "As", 4, 29, 5, 5, (-3, 3), 3, 4), // As
    (34, 80, 78.971, "Se", 4, 30, 6, 6, (-2, 1), 2, 3), // Se
    (35, 79, 79.904, "Br", 4, 31, 7, 7, (-1, 1), 1, 1), // Br
    (36, 84, 83.798, "Kr", 4, 32, 8, 8, (-1, 1), 0, 0), // Kr: allow Kr compounds
    (37, 85, 85.468, "Rb", 5, 1, 1, 1, (-1, 1), 1, 0), // Rb
    (38, 88, 87.62, "Sr", 5, 2, 2, 2, (0, 2), 2, 0),   // Sr
    (39, 89, 88.906, "Y", 5, 3, 3, 3, (0, 3), 3, 0),   // Y
    (40, 90, 91.224, "Zr", 5, 18, 4, 4, (0, 4), 4, 0), // Zr
    (41, 93, 92.906, "Nb", 5, 19, 5, 5, (0, 5), 5, 0), // Nb
    (42, 98, 95.95, "Mo", 5, 20, 6, 6, (0, 6), 6, 0),  // Mo
    (43, 97, 98.0, "Tc", 5, 21, 7, 7, (0, 7), 7, 0), // Tc: using 97Tc as reference isotope based on PubChem data
    (44, 102, 101.07, "Ru", 5, 22, 8, 8, (0, 8), 8, 0), // Ru
    (45, 103, 102.91, "Rh", 5, 23, 9, 6, (0, 6), 6, 0), // Rh
    (46, 106, 106.42, "Pd", 5, 24, 10, 5, (0, 5), 5, 0), // Pd
    (47, 107, 107.87, "Ag", 5, 25, 11, 4, (0, 4), 3, 0), // Ag
    (48, 114, 112.41, "Cd", 5, 26, 2, 2, (0, 2), 2, 0), // Cd
    (49, 115, 114.82, "In", 5, 27, 3, 3, (0, 3), 3, 0), // In
    (50, 120, 118.71, "Sn", 5, 28, 4, 4, (0, 4), 4, 4), // Sn
    (51, 121, 121.76, "Sb", 5, 29, 5, 5, (-3, 3), 3, 4), // Sb
    (52, 130, 127.60, "Te", 5, 30, 6, 6, (-2, 2), 2, 3), // Te
    (53, 127, 126.90, "I", 5, 31, 7, 7, (-1, 1), 1, 1), // I
    (54, 132, 131.29, "Xe", 5, 32, 8, 8, (-2, 1), 0, 0), // Xe: allow Xe compounds
    (55, 133, 132.91, "Cs", 6, 1, 1, 1, (-1, 1), 1, 0), // Cs
    (56, 138, 137.33, "Ba", 6, 2, 2, 2, (0, 2), 2, 0), // Ba
    (57, 139, 138.91, "La", 6, 3, 3, 3, (0, 3), 1, 0), // La
    (58, 140, 140.12, "Ce", 6, 4, 4, 4, (0, 4), 2, 0), // Ce
    (59, 141, 140.91, "Pr", 6, 5, 5, 4, (0, 4), 3, 0), // Pr
    (60, 142, 144.24, "Nd", 6, 6, 6, 3, (0, 3), 4, 0), // Nd
    (61, 145, 145.0, "Pm", 6, 7, 7, 3, (0, 3), 5, 0), // Pm
    (62, 152, 150.36, "Sm", 6, 8, 8, 3, (0, 3), 6, 0), // Sm
    (63, 153, 151.96, "Eu", 6, 9, 9, 3, (0, 3), 7, 0), // Eu
    (64, 158, 157.25, "Gd", 6, 10, 10, 3, (0, 3), 8, 0), // Gd
    (65, 159, 158.93, "Tb", 6, 11, 11, 4, (0, 4), 7, 0), // Tb
    (66, 164, 162.50, "Dy", 6, 12, 12, 4, (0, 4), 5, 0), // Dy
    (67, 165, 164.93, "Ho", 6, 13, 13, 3, (0, 3), 4, 0), // Ho
    (68, 166, 167.26, "Er", 6, 14, 14, 3, (0, 3), 3, 0), // Er
    (69, 169, 168.93, "Tm", 6, 15, 15, 3, (0, 3), 2, 0), // Tm
    (70, 174, 173.05, "Yb", 6, 16, 16, 3, (0, 3), 1, 0), // Yb
    (71, 175, 174.97, "Lu", 6, 17, 3, 3, (0, 3), 1, 0), // Lu
    (72, 180, 178.49, "Hf", 6, 18, 4, 4, (0, 4), 2, 0), // Hf
    (73, 181, 180.95, "Ta", 6, 19, 5, 5, (0, 5), 5, 0), // Ta
    (74, 184, 183.84, "W", 6, 20, 6, 6, (0, 6), 6, 0), // W
    (75, 187, 186.21, "Re", 6, 21, 7, 7, (0, 7), 7, 0), // Re
    (76, 192, 190.23, "Os", 6, 22, 8, 8, (0, 8), 8, 0), // Os
    (77, 193, 192.22, "Ir", 6, 23, 9, 6, (0, 6), 6, 0), // Ir
    (78, 195, 195.08, "Pt", 6, 24, 10, 6, (0, 6), 4, 0), // Pt
    (79, 197, 196.97, "Au", 6, 25, 11, 3, (0, 5), 2, 0), // Au
    (80, 202, 200.59, "Hg", 6, 26, 12, 4, (0, 4), 2, 0), // Hg
    (81, 205, 204.38, "Tl", 6, 27, 3, 3, (0, 3), 3, 0), // Tl
    (82, 208, 207.2, "Pb", 6, 28, 4, 4, (0, 4), 4, 0), // Pb
    (83, 209, 208.98, "Bi", 6, 29, 5, 5, (-3, 3), 3, 3), // Bi
    (84, 209, 209.0, "Po", 6, 30, 6, 6, (-2, 2), 2, 2), // Po
    (85, 210, 210.0, "At", 6, 31, 7, 7, (0, 7), 1, 1), // At
    (86, 222, 222.0, "Rn", 6, 32, 8, 8, (0, 8), 2, 0), // Rn
    (87, 223, 223.0, "Fr", 7, 1, 1, 2, (0, 1), 1, 0), // Fr
    (88, 226, 226.0, "Ra", 7, 2, 2, 2, (0, 2), 2, 0), // Ra
    (89, 227, 227.0, "Ac", 7, 3, 3, 3, (0, 3), 1, 0), // Ac
    (90, 232, 232.04, "Th", 7, 4, 4, 4, (0, 4), 2, 0), // Th
    (91, 231, 231.04, "Pa", 7, 5, 5, 5, (0, 5), 3, 0), // Pa
    (92, 238, 238.03, "U", 7, 6, 6, 6, (0, 6), 4, 0), // U
    (93, 237, 237.0, "Np", 7, 7, 7, 7, (0, 7), 5, 0), // Np
    (94, 244, 244.0, "Pu", 7, 8, 8, 8, (0, 8), 6, 0), // Pu
    (95, 243, 243.0, "Am", 7, 9, 9, 7, (0, 7), 7, 0), // Am
    (96, 247, 247.0, "Cm", 7, 10, 10, 4, (0, 6), 8, 0), // Cm
    (97, 247, 247.0, "Bk", 7, 11, 11, 4, (0, 5), 7, 0), // Bk
    (98, 251, 251.0, "Cf", 7, 12, 12, 4, (0, 5), 6, 0), // Cf
    (99, 252, 252.0, "Es", 7, 13, 13, 3, (0, 4), 4, 0), // Es
    (100, 257, 257.0, "Fm", 7, 14, 14, 3, (0, 3), 3, 0), // Fm
    (101, 258, 258.0, "Md", 7, 15, 15, 3, (0, 3), 2, 0), // Md
    (102, 259, 259.0, "No", 7, 16, 16, 3, (0, 3), 0, 0), // No
    (103, 266, 226.0, "Lr", 7, 17, 3, 3, (0, 3), 1, 0), // Lr
    (104, 267, 267.0, "Rf", 7, 18, 4, 4, (0, 4), 2, 0), // Rf
    (105, 268, 268.0, "Db", 7, 19, 5, 5, (0, 5), 3, 0), // Db
    (106, 269, 269.0, "Sg", 7, 20, 6, 6, (0, 6), 4, 0), // Sg
    (107, 270, 270.0, "Bh", 7, 21, 7, 7, (0, 7), 5, 0), // Bh
    (108, 269, 269.0, "Hs", 7, 22, 8, 8, (0, 8), 6, 0), // Hs
    (109, 277, 277.0, "Mt", 7, 23, 9, 7, (0, 6), 5, 0), // Mt
    (110, 282, 282.0, "Ds", 7, 24, 10, 6, (0, 6), 4, 0), // Ds
    (111, 282, 282.0, "Rg", 7, 25, 11, 5, (0, 5), 3, 0), // Rg
    (112, 286, 286.0, "Cn", 7, 26, 12, 4, (0, 4), 2, 0), // Cn
    (113, 286, 286.0, "Nh", 7, 27, 3, 3, (0, 3), 1, 0), // Nh
    (114, 290, 290.0, "Fl", 7, 28, 4, 4, (0, 2), 0, 0), // Fl
    (115, 290, 290.0, "Mc", 7, 29, 5, 5, (0, 0), 0, 0), // Mc
    (116, 293, 293.0, "Lv", 7, 30, 6, 6, (0, 0), 0, 0), // Lv
    (117, 294, 294.0, "Ts", 7, 31, 7, 7, (0, 0), 0, 0), // Ts
    (118, 294, 294.0, "Og", 7, 32, 8, 8, (0, 0), 0, 0), // Og: PubChem uses 295 although only 294Og is known
];
...
impl Element {
    ...
    // Get group number (32-group layout) for element.
...
impl TryFrom<&str> for Element {
    ...
    fn try_from(s: &str) -> Result<Self, ElementError> {
        Self::from_symbol(s).ok_or_else(|| ElementError::InvalidSymbol {
            symbol: s.to_string(),
        })
    }
}
...
impl TryFrom<u8> for Element {
    ...
    fn try_from(number: u8) -> Result<Self, ElementError> {
        Self::from_atomic_number(number).ok_or(ElementError::InvalidAtomicNumber {
...
impl FromStr for Element {
    ...
    fn from_str(s: &str) -> Result<Self, ElementError> {
        Self::try_from(s)
    }
}
...
mod tests {
    ...
    #[rstest]
    #[case::h(Element::H, "H", 1, 1, 1.008, 1, 1, 1, 1)]
    #[case::he(Element::He, "He", 2, 4, 4.0026, 1, 32, 0, 0)]
    ...
    #[rstest]
    #[case::h(Element::H, -1, 1, 1, 0)]
    #[case::he(Element::He, 0, 0, 0, 0)]
    #[case::c(Element::C, -4, 1, 3, 4)]
    #[case::n(Element::N, -3, 1, 3, 4)]
