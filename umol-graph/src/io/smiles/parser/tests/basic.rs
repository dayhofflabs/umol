...
#[case::hcount_h3(b"[CH3]", Element::C, false, None, None, Some(3), Some(0), None)]
#[case::hcount_h4(b"[CH4]", Element::C, false, None, None, Some(4), Some(0), None)]
#[case::hcount_aromatic(b"[cH]", Element::C, true, None, None, Some(1), Some(0), None)]
#[case::hcount_two_characters_1(b"[ClH]", Element::Cl, false, None, None, Some(1), Some(0), None)]
