...
#[case::chirality_cw(b"[C@]", Element::C, false, None, Some(Chirality::Clockwise), Some(0), None, None)]
#[case::chirality_ccw(b"[C@@]", Element::C, false, None, Some(Chirality::CounterClockwise), Some(0), None, None)]
