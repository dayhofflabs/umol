...
#[case::aromatic_link("c1ccccc1-c2ccccc2", "c1c(cccc1)-c1ccccc1")]
...
#[case::ring_hydrogen("C[C@H]1CCCCO1", "C[C@@H]1OCCCC1")]
#[case::ring_root("[C@H]1(F)CCCCO1", "[C@H]1(OCCCC1)F")]
#[case::two_stereo_closures("N[C@]12CCCC1CCC2", "N[C@]12C(CCC2)CCC1")]
...
#[case::ring_markers("C1/C=C/C=C/CCC1", "C/1CCC\\C=C\\C=C1")]
...
#[case::ring_donation("N1CC[Cu]->1", "N1<-[Cu]CC1")]
#[case::any("C~C", "C~C")]
