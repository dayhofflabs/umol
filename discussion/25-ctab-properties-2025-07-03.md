...
|----------------------------------------------------------------------------------------------------------------|
| Property   | Symbol | Implementation | Class   | RDKit* | ChemAxon@ | CDK^   | Indigo+ |  Notes                |
|------------|--------|----------------|---------|--------|-----------|--------|--------------------------------|
...
| Ring Bonds | RBC    | x              | Query   | x      | x         | x      |         |                       |
| Subs Count | SUB    | x              | Query   | x      | x         | x      |         |                       |
| Unsat Atom | UNS    | x              | Query   | x      | x         | x      |         |                       |
