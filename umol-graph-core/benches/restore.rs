...
//!
//! Fixed-relation row restoration also measures retained capacity: setup removes rows from a
...
//! restoration reuses columns; both native fixed-relation operations still rebuild incidence.
