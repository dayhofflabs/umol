...
mod tests {
    ...
    #[rustfmt::skip]
    #[rstest]
    #[case::new(DativeBondAst::new(NumForm::Lit(2)),
    ...
    #[case::pattern_wildcard_matches(
        DativeBondAst::new(NumForm::Undetermined),
    ...
    #[case::narrows_order(
        DativeBondAst { order: NumForm::Undetermined, constraints: DativeBondConstraintsAst::new() },
