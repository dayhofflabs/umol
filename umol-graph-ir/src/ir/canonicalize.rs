...
use umol_graph_core::{
    ...
    NodeId, ParticipantPosition, RelationId, SubdivisionNodeSource, Unordered,
};
...
/// Canonicalize a reaction and return the dense union-frame correspondence used by the
/// transformation. This is test support for the canonicalization preservation properties.
...
mod tests {
    ...
    fn test_molecule_canonical_eq_contradiction(canonicalization_context: CanonicalizationContext) {
        ...
        left_contradiction.atom_mut(AtomId(0)).attributes.charge =
        ...
        right_contradiction.atom_mut(AtomId(0)).attributes.charge =
            NumForm::lit_set(Vec::<i64>::new());
