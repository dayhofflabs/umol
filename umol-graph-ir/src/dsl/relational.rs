...
mod tests {
    ...
    #[case::dative_all_donors(RelationalConstraint::DativeBondAllDonors { bond: DativeBondId(0), predicate: Box::new(AtomConstraintAst::Valence(ValueAst::Lit(3))) },
        "{:dative-bond-all-donors [0 {:valence 3}]}")]
    #[case::dative_any_donor(RelationalConstraint::DativeBondAnyDonor { bond: DativeBondId(0), predicate: Box::new(AtomConstraintAst::Valence(ValueAst::Lit(3))) },
    ...
    #[case::dative_acceptor_satisfies(RelationalConstraint::DativeBondAcceptorSatisfies { bond: DativeBondId(0),
        predicate: Box::new(AtomConstraintAst::Degree(ValueAst::Lit(2))) }, "{:dative-bond-acceptor-satisfies [0 {:degree 2}]}")]
    ...
    #[case::aromatic_system_all_atoms(RelationalConstraint::AromaticSystemAllAtoms { system: AromaticSystemId(0), predicate: Box::new(AtomConstraintAst::Valence(ValueAst::Lit(4))) },
        "{:aromatic-system-all-atoms [0 {:valence 4}]}")]
    #[case::aromatic_system_any_atom(RelationalConstraint::AromaticSystemAnyAtom { system: AromaticSystemId(0), predicate: Box::new(AtomConstraintAst::Degree(ValueAst::Lit(3))) },
    ...
    #[case::multicenter_all_atoms(RelationalConstraint::MulticenterBondAllAtoms { bond: MulticenterBondId(0), predicate: Box::new(AtomConstraintAst::Valence(ValueAst::Lit(4))) },
        "{:multicenter-bond-all-atoms [0 {:valence 4}]}")]
    #[case::multicenter_any_atom(RelationalConstraint::MulticenterBondAnyAtom { bond: MulticenterBondId(0), predicate: Box::new(AtomConstraintAst::Degree(ValueAst::Lit(3))) },
    ...
    #[case::stereo_atom_all_ligands(RelationalConstraint::StereoAtomAllLigands { stereo_atom: StereoAtomId(0), predicate: Box::new(AtomConstraintAst::Valence(ValueAst::Lit(4))) },
        "{:stereo-atom-all-ligands [0 {:valence 4}]}")]
    #[case::stereo_atom_any_ligand(RelationalConstraint::StereoAtomAnyLigand { stereo_atom: StereoAtomId(0), predicate: Box::new(AtomConstraintAst::Degree(ValueAst::Lit(3))) },
    ...
    #[case::stereo_bond_all_ligands(RelationalConstraint::StereoBondAllLigands { stereo_bond: StereoBondId(0), predicate: Box::new(AtomConstraintAst::Valence(ValueAst::Lit(4))) },
        "{:stereo-bond-all-ligands [0 {:valence 4}]}")]
    #[case::stereo_bond_any_ligand(RelationalConstraint::StereoBondAnyLigand { stereo_bond: StereoBondId(0), predicate: Box::new(AtomConstraintAst::Degree(ValueAst::Lit(3))) },
