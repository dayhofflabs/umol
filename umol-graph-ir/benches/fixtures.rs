...
pub const MOL_BENZENE: &str = r##"{:atoms ["C" "C" "C" "C" "C" "C"]
 ...
 :aromatic-systems [{:atoms [0 1 2 3 4 5] :attrs "[1,1,1,1,1,1]#e6"}]}"##;
...
pub const MOL_DIBORANE: &str = r##"{:atoms ["B" "H" "B" "H" "H" "H" "H" "H"]
 ...
 :multicenter-bonds [{:atoms [0 1 2] :attrs "[1,1,0]#e2"}
               {:atoms [0 3 2] :attrs "[0,1,1]#e2"}]}"##;

pub const MOL_WITH_CONSTRAINTS: &str = r##"{:atoms [[:c1 "C"] [:c2 "C"] [:o "O"]]
 :bonds [{:id :b1 :atoms [:c1 :c2] :attrs "1"} {:id :b2 :atoms [:c2 :o] :attrs "1"}]
