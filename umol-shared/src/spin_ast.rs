...
impl SpinStateAst {
    ...
    pub fn to_pair(&self) -> (ValueAst, ValueAst) {
        match self {
            Self::Lit(s) => (
                ValueAst::Lit(s.unpaired_electrons() as i64),
                ValueAst::Lit(s.multiplicity().multiplicity() as i64),
            ),
            Self::Pair {
                unpaired,
                multiplicity,
    ...
    pub fn matches(&self, state: SpinState) -> bool {
        match self {
            ...
            Self::Pair {
                ...
                unpaired.matches(state.unpaired_electrons() as i64)
                    && multiplicity.matches(state.multiplicity().multiplicity() as i64)
            }
        }
    }
...
mod tests {
    ...
    #[case(SpinStateAst::Pair { unpaired: ValueAst::Lit(2), multiplicity: ValueAst::Lit(3) }, false)]
    ...
    #[rustfmt::skip]
    #[rstest]
    #[case::undetermined_any(SpinStateAst::default(), spin!("#u2"), true)]
    #[case::lit_match(SpinStateAst::Lit(spin!("#u2")), spin!("#u2"), true)]
    #[case::lit_mismatch(SpinStateAst::Lit(spin!("#u2")), spin!("#u0"), false)]
    #[case::pair_both_match(SpinStateAst::Pair { unpaired: ValueAst::Lit(2), multiplicity: ValueAst::Lit(3) }, spin!("#u2"), true)]
    #[case::pair_unpaired_only(SpinStateAst::Pair { unpaired: ValueAst::Lit(2), multiplicity: ValueAst::Undetermined }, spin!("#u2#s1"), true)]
    #[case::pair_unpaired_mismatch(SpinStateAst::Pair { unpaired: ValueAst::Lit(2), multiplicity: ValueAst::Undetermined }, spin!("#u0"), false)]
    #[case::pair_multiplicity_only(SpinStateAst::Pair { unpaired: ValueAst::Undetermined, multiplicity: ValueAst::Lit(3) }, spin!("#u2"), true)]
    #[case::pair_both_undetermined(SpinStateAst::Pair { unpaired: ValueAst::Undetermined, multiplicity: ValueAst::Undetermined }, spin!("#u2"), true)]
    ...
    #[rustfmt::skip]
    #[rstest]
    #[case::undetermined(SpinStateAst::default(), Ok(None))]
    #[case::lit(SpinStateAst::Lit(spin!("#u2")), Ok(Some(spin!("#u2"))))]
    #[case::pair_concrete(SpinStateAst::Pair { unpaired: ValueAst::Lit(2), multiplicity: ValueAst::Lit(3) }, Ok(Some(spin!("#u2#s3"))))]
    #[case::pair_partial(SpinStateAst::Pair { unpaired: ValueAst::Lit(2), multiplicity: ValueAst::Undetermined }, Ok(None))]
    #[case::pair_undetermined(SpinStateAst::Pair { unpaired: ValueAst::Undetermined, multiplicity: ValueAst::Undetermined }, Ok(None))]
    #[case::pair_incompatible(SpinStateAst::Pair { unpaired: ValueAst::Lit(0), multiplicity: ValueAst::Lit(3) }, Err(SpinStateError::Incompatible { unpaired_electrons: 0, multiplicity: SpinMultiplicity::Triplet }))]
