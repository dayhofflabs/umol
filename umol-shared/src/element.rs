...
// valence_electrons, valence_capacity, max_valence, (min_charge, max_charge), max_unpaired_electrons, max_implicit_hydrogens)
#[allow(clippy::type_complexity)]
static ELEMENT_DATA: [(u8, u32, f64, &str, u8, u8, u8, u8, u8, (i8, i8), u8, u8); 118] = [
    (1, 1, 1.0080, "H", 1, 1, 1, 2, 1, (-1, 1), 1, 0),    // H
    (2, 4, 4.0026, "He", 1, 32, 0, 2, 0, (0, 0), 0, 0),   // He: no valence electrons
    (3, 7, 6.94, "Li", 2, 1, 1, 8, 1, (-1, 1), 1, 1),     // Li
    (4, 9, 9.0122, "Be", 2, 2, 2, 8, 2, (0, 2), 1, 2),    // Be
    (5, 11, 10.81, "B", 2, 27, 3, 8, 4, (-3, 3), 1, 4),   // B
    (6, 12, 12.011, "C", 2, 28, 4, 8, 4, (-4, 1), 3, 4),  // C
    (7, 14, 14.007, "N", 2, 29, 5, 8, 4, (-3, 1), 3, 4),  // N
    (8, 16, 15.999, "O", 2, 30, 6, 8, 3, (-2, 1), 2, 3),  // O
    (9, 19, 18.998, "F", 2, 31, 7, 8, 1, (-1, 0), 1, 1),  // F
    (10, 20, 20.180, "Ne", 2, 32, 0, 8, 0, (0, 0), 0, 0), // Ne: no valence electrons
    (11, 23, 22.990, "Na", 3, 1, 1, 8, 1, (-1, 1), 1, 1), // Na
    (12, 24, 24.305, "Mg", 3, 2, 2, 8, 2, (0, 2), 1, 2),  // Mg
    (13, 27, 26.982, "Al", 3, 27, 3, 8, 3, (-1, 3), 1, 4), // Al
    (14, 28, 28.085, "Si", 3, 28, 4, 12, 4, (-4, 1), 2, 4), // Si
    (15, 31, 30.974, "P", 3, 29, 5, 12, 5, (-3, 1), 3, 4), // P
    (16, 32, 32.06, "S", 3, 30, 6, 12, 6, (-2, 1), 2, 3),  // S
    (17, 35, 35.45, "Cl", 3, 31, 7, 14, 7, (-1, 1), 1, 1), // Cl
    (18, 40, 39.95, "Ar", 3, 32, 0, 8, 0, (0, 0), 0, 0),  // Ar: no valence electrons
    (19, 39, 39.098, "K", 4, 1, 1, 8, 1, (-1, 1), 1, 0),  // K
    (20, 40, 40.078, "Ca", 4, 2, 2, 8, 2, (0, 2), 2, 0),  // Ca
    (21, 45, 44.956, "Sc", 4, 3, 3, 18, 3, (0, 3), 3, 0),  // Sc
    (22, 48, 47.867, "Ti", 4, 18, 4, 18, 4, (0, 4), 4, 0), // Ti
    (23, 51, 50.942, "V", 4, 19, 5, 18, 5, (0, 5), 5, 0),  // V
    (24, 52, 51.996, "Cr", 4, 20, 6, 18, 6, (0, 6), 6, 0), // Cr
    (25, 55, 54.938, "Mn", 4, 21, 7, 18, 7, (0, 7), 7, 0), // Mn
    (26, 56, 55.845, "Fe", 4, 22, 8, 18, 6, (0, 6), 6, 0), // Fe
    (27, 59, 58.933, "Co", 4, 23, 9, 18, 5, (0, 5), 5, 0), // Co
    (28, 58, 58.693, "Ni", 4, 24, 10, 18, 4, (0, 4), 4, 0), // Ni
    (29, 63, 63.546, "Cu", 4, 25, 11, 18, 3, (0, 3), 3, 0), // Cu
    (30, 64, 65.38, "Zn", 4, 26, 2, 18, 2, (0, 2), 2, 0),  // Zn
    (31, 69, 69.723, "Ga", 4, 27, 3, 12, 3, (0, 3), 3, 0), // Ga
    (32, 74, 72.630, "Ge", 4, 28, 4, 12, 4, (0, 4), 4, 0), // Ge
    (33, 75, 74.922, "As", 4, 29, 5, 12, 5, (-3, 3), 3, 4), // As
    (34, 80, 78.971, "Se", 4, 30, 6, 12, 6, (-2, 1), 2, 3), // Se
    (35, 79, 79.904, "Br", 4, 31, 7, 14, 7, (-1, 1), 1, 1), // Br
    (36, 84, 83.798, "Kr", 4, 32, 8, 18, 8, (-1, 1), 0, 0), // Kr: allow Kr compounds
    (37, 85, 85.468, "Rb", 5, 1, 1, 8, 1, (-1, 1), 1, 0), // Rb
    (38, 88, 87.62, "Sr", 5, 2, 2, 8, 2, (0, 2), 2, 0),   // Sr
    (39, 89, 88.906, "Y", 5, 3, 3, 18, 3, (0, 3), 3, 0),   // Y
    (40, 90, 91.224, "Zr", 5, 18, 4, 18, 4, (0, 4), 4, 0), // Zr
    (41, 93, 92.906, "Nb", 5, 19, 5, 18, 5, (0, 5), 5, 0), // Nb
    (42, 98, 95.95, "Mo", 5, 20, 6, 18, 6, (0, 6), 6, 0),  // Mo
    (43, 97, 98.0, "Tc", 5, 21, 7, 18, 7, (0, 7), 7, 0), // Tc: using 97Tc as reference isotope based on PubChem data
    (44, 102, 101.07, "Ru", 5, 22, 8, 18, 8, (0, 8), 8, 0), // Ru
    (45, 103, 102.91, "Rh", 5, 23, 9, 18, 6, (0, 6), 6, 0), // Rh
    (46, 106, 106.42, "Pd", 5, 24, 10, 18, 5, (0, 5), 5, 0), // Pd
    (47, 107, 107.87, "Ag", 5, 25, 11, 18, 4, (0, 4), 3, 0), // Ag
    (48, 114, 112.41, "Cd", 5, 26, 2, 18, 2, (0, 2), 2, 0), // Cd
    (49, 115, 114.82, "In", 5, 27, 3, 12, 3, (0, 3), 3, 0), // In
    (50, 120, 118.71, "Sn", 5, 28, 4, 12, 4, (0, 4), 4, 4), // Sn
    (51, 121, 121.76, "Sb", 5, 29, 5, 12, 5, (-3, 3), 3, 4), // Sb
    (52, 130, 127.60, "Te", 5, 30, 6, 14, 6, (-2, 2), 2, 3), // Te
    (53, 127, 126.90, "I", 5, 31, 7, 16, 7, (-1, 1), 1, 1), // I
    ...
    (75, 187, 186.21, "Re", 6, 21, 7, 18, 7, (0, 7), 7, 0), // Re
    (76, 192, 190.23, "Os", 6, 22, 8, 18, 8, (0, 8), 8, 0), // Os
    (77, 193, 192.22, "Ir", 6, 23, 9, 18, 6, (0, 6), 6, 0), // Ir
    (78, 195, 195.08, "Pt", 6, 24, 10, 18, 6, (0, 6), 4, 0), // Pt
    (79, 197, 196.97, "Au", 6, 25, 11, 18, 3, (0, 5), 2, 0), // Au
    (80, 202, 200.59, "Hg", 6, 26, 12, 18, 4, (0, 4), 2, 0), // Hg
    (81, 205, 204.38, "Tl", 6, 27, 3, 12, 3, (0, 3), 3, 0), // Tl
    (82, 208, 207.2, "Pb", 6, 28, 4, 12, 4, (0, 4), 4, 0), // Pb
    (83, 209, 208.98, "Bi", 6, 29, 5, 12, 5, (-3, 3), 3, 3), // Bi
    (84, 209, 209.0, "Po", 6, 30, 6, 14, 6, (-2, 2), 2, 2), // Po
    (85, 210, 210.0, "At", 6, 31, 7, 16, 7, (0, 7), 1, 1), // At
    ...
    (107, 270, 270.0, "Bh", 7, 21, 7, 18, 7, (0, 7), 5, 0), // Bh
    (108, 269, 269.0, "Hs", 7, 22, 8, 18, 8, (0, 8), 6, 0), // Hs
    (109, 277, 277.0, "Mt", 7, 23, 9, 18, 7, (0, 6), 5, 0), // Mt
    (110, 282, 282.0, "Ds", 7, 24, 10, 18, 6, (0, 6), 4, 0), // Ds
    (111, 282, 282.0, "Rg", 7, 25, 11, 18, 5, (0, 5), 3, 0), // Rg
    (112, 286, 286.0, "Cn", 7, 26, 12, 18, 4, (0, 4), 2, 0), // Cn
    (113, 286, 286.0, "Nh", 7, 27, 3, 12, 3, (0, 3), 1, 0), // Nh
    (114, 290, 290.0, "Fl", 7, 28, 4, 12, 4, (0, 2), 0, 0), // Fl
    (115, 290, 290.0, "Mc", 7, 29, 5, 12, 5, (0, 0), 0, 0), // Mc
    (116, 293, 293.0, "Lv", 7, 30, 6, 14, 6, (0, 0), 0, 0), // Lv
    (117, 294, 294.0, "Ts", 7, 31, 7, 16, 7, (0, 0), 0, 0), // Ts
    (118, 294, 294.0, "Og", 7, 32, 8, 18, 8, (0, 0), 0, 0), // Og: PubChem uses 295 although only 294Og is known
];
...
mod tests {
    ...
    #[rstest]
    #[case::h(Element::H, 2, 1, -1, 1, 1, 0)]
    #[case::he(Element::He, 2, 0, 0, 0, 0, 0)]
    #[case::c(Element::C, 8, 4, -4, 1, 3, 4)]
    #[case::n(Element::N, 8, 4, -3, 1, 3, 4)]
    #[case::o(Element::O, 8, 3, -2, 1, 2, 3)]
    #[case::f(Element::F, 8, 1, -1, 0, 1, 1)]
    #[case::na(Element::Na, 8, 1, -1, 1, 1, 1)]
    #[case::si(Element::Si, 12, 4, -4, 1, 2, 4)]
    #[case::p(Element::P, 12, 5, -3, 1, 3, 4)]
    #[case::s(Element::S, 12, 6, -2, 1, 2, 3)]
    #[case::cl(Element::Cl, 14, 7, -1, 1, 1, 1)]
    #[case::ar(Element::Ar, 8, 0, 0, 0, 0, 0)]
    #[case::fe(Element::Fe, 18, 6, 0, 6, 6, 0)]
    #[case::zn(Element::Zn, 18, 2, 0, 2, 2, 0)]
    #[case::se(Element::Se, 12, 6, -2, 1, 2, 3)]
    #[case::br(Element::Br, 14, 7, -1, 1, 1, 1)]
    #[case::kr(Element::Kr, 18, 8, -1, 1, 0, 0)]
    #[case::te(Element::Te, 14, 6, -2, 2, 2, 3)]
    ...
    fn test_element_bounds(
        ...
        assert_eq!(element.valence_capacity(), valence_capacity);
    ...
    fn test_all_elements_have_data() {
        for data in &ELEMENT_DATA {
            ...
            assert!(data.7 <= 32); // valence capacity
            assert!(data.8 <= 32); // max valence
            assert!(data.9 .0 <= data.9 .1); // charge bounds
            assert!(data.10 <= 10); // max unpaired electrons
            assert!(data.11 <= 4); // max implicit hydrogens
        }
    }
