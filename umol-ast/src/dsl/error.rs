...
pub enum ParseError {
    ...
    #[error("unknown noncovalent-bond predicate: {0}")]
    UnknownNoncovalentBondPredicate(String),
    #[error("duplicate noncovalent-bond predicate: {0}")]
    DuplicateNoncovalentBondPredicate(String),
