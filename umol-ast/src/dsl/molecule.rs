...
mod tests {
    ...
    #[case::constraints_atom_ring_size_litset(r##"{:atoms ["C"] :bonds [] :constraints [{:atom [0 {:ring-size [5 6]}]}]}"##)]
    ...
    #[case::atom_ring_size_litset(r##"{:atoms ["C"] :bonds [] :constraints [{:atom [0 {:ring-size [5 6]}]}]}"##)]
