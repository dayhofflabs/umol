...
fn resolve_atom_span(
    ...
    Ok(match span {
        ...
        EntitySpan::Modified {
            ...
            lhs: resolve_atom_spec(left, aliases)?,
            rhs: resolve_atom_spec(right, aliases)?,
        },
    })
}
...
fn resolve_constraint_span(
    ...
    Ok(match input {
        ConstraintSpanInput::Unchanged(dsl) => {
            ConstraintSpan::Unchanged(dsl.into_ast(counts, meta)?)
        }
