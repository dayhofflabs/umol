...
#[case::constraints_atom_ring_size_set(r##"{:atoms ["C"] :bonds [] :constraints [{:atom [0 {:ring-size [5 6]}]}]}"##)]
#[case::constraints_atom_ring_size_conj(r##"{:atoms ["C"] :bonds [] :constraints [{:atom [0 {:ring-size 5}]} {:atom [0 {:ring-size 6}]}]}"##)]
...
#[case::constraints_dative_ring_count(r##"{:atoms ["C" "N"] :bonds [] :dative-bonds [{:donor 0 :acceptor 1 :type "1#R"}] :constraints [{:dative-bond [0 {:ring-count 1}]}]}"##)]
...
#[case::stereo_atom_inline_constraints(r##"{:atoms ["C" "F" "Cl" "Br" "I"] :bonds [[0 1 "1"] [0 2 "1"] [0 3 "1"] [0 4 "1"]] :stereo-atoms [{:site 0 :ligands [1 2 3 4] :type "Th1#f(0,1,2)#g/"}]}"##)]
#[case::stereo_atom_molecule_constraint(r##"{:atoms ["C" "F" "Cl" "Br" "I"] :bonds [[0 1 "1"] [0 2 "1"] [0 3 "1"] [0 4 "1"]] :stereo-atoms [{:site 0 :ligands [1 2 3 4] :type "Th1"}] :constraints [{:stereo-atom [0 {:kind :tetrahedral :stereogenicity {:relation :stereogenic}}]}]}"##)]
#[case::stereo_bond_inline_constraints(r##"{:atoms ["C" "C" "C" "C"] :bonds [[0 1 "1"] [1 2 "2"] [2 3 "1"]] :stereo-bonds [{:site 1 :ligands [0 3] :type "Ct1#g/"}]}"##)]
#[case::stereo_bond_molecule_constraint(r##"{:atoms ["C" "C" "C" "C"] :bonds [[0 1 "1"] [1 2 "2"] [2 3 "1"]] :stereo-bonds [{:site 1 :ligands [0 3] :type "Ct1"}] :constraints [{:stereo-bond [0 {:kind :cis-trans :stereogenicity {:relation :stereogenic}}]}]}"##)]
...
#[case::atom_ring_size_set(r##"{:atoms ["C"] :bonds [] :constraints [{:atom [0 {:ring-size [5 6]}]}]}"##)]
#[case::atom_ring_size_conj(r##"{:atoms ["C"] :bonds [] :constraints [{:atom [0 {:ring-size 5}]} {:atom [0 {:ring-size 6}]}]}"##)]
...
#[case::dative_ring_count(r##"{:atoms ["C" "N"] :bonds [] :dative-bonds [{:donor 0 :acceptor 1 :type :single}] :constraints [{:dative-bond [0 {:ring-count 1}]}]}"##)]
#[case::dative_ring_size(r##"{:atoms ["C" "N"] :bonds [] :dative-bonds [{:donor 0 :acceptor 1 :type :single}] :constraints [{:dative-bond [0 {:ring-size 5}]}]}"##)]
