...
- **`aromatic-string`** (**§7.9**) and **`multicenter-string`** (**§7.10**) lead with an **electron counts** specification (**`*`** or a **`[n,n,…]`** vector) — the counterpart of the bond-string's order or the atom-string's element.
